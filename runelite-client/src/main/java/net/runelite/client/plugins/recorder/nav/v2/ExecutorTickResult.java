 ...
 *  {@link V2Executor#tick()} call. Replaces the prior cross-layer replan
 *  boolean (removed) and out-of-band error fields with one immutable
 *  record carrying everything Lane 6 needs to correlate a per-tick trace.
 *
